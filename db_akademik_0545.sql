...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Jan 2022 pada 10.26
...
--
-- Struktur dari tabel `tbl_students_0545`
--

CREATE TABLE `tbl_students_0545` (
  `no` int(2) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_students_0545`
--

INSERT INTO `tbl_students_0545` (`no`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indeks untuk tabel `tbl_students_0545`
--
ALTER TABLE `tbl_students_0545`
  ADD PRIMARY KEY (`no`);
...
--
-- AUTO_INCREMENT untuk tabel `tbl_students_0545`
--
ALTER TABLE `tbl_students_0545`
  MODIFY `no` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
COMMIT;
